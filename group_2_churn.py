...
Original file is located at
    https://colab.research.google.com/drive/1YMGvcIQEZmwPXEWLoXJb4wsr_vOXMkV2
"""
...
joblib.dump(rf_model, 'random_forest_telecom_churn.pkl')
...
model = joblib.load("random_forest_telecom_churn.pkl")
...
def main():
    ...
    state = st.selectbox("State", list(range(52)), help="Select the state (0 to 51) representing each state including District of Columbia")
    account_length = st.number_input("Account Length (days)", min_value=1, max_value=500, value=100)
    voice_messages = st.number_input("Number of Voice Messages", min_value=0, max_value=100, value=0)
    intl_mins = st.number_input("International Minutes", min_value=0.0, max_value=200.0, value=10.0)
    intl_calls = st.number_input("International Calls", min_value=0, max_value=100, value=0)
    day_mins = st.number_input("Daytime Minutes", min_value=0.0, max_value=500.0, value=100.0)
    day_calls = st.number_input("Daytime Calls", min_value=0, max_value=200, value=50)
    ...
    night_mins = st.number_input("Nighttime Minutes", min_value=0.0, max_value=500.0, value=100.0)
    night_calls = st.number_input("Nighttime Calls", min_value=0, max_value=200, value=50)
    voice_plan_yes = st.selectbox("Voicemail Plan", ["yes", "no"])
    intl_plan_yes = st.selectbox("International Plan", ["yes", "no"])
    ...
    user_input = pd.DataFrame({
        ...
        'voice.plan_yes': [1 if voice_plan_yes == "yes" else 0],
